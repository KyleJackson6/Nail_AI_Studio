...
export default function HomePage() {
  ...
  return (
    <main className="min-h-screen bg-[radial-gradient(circle_at_top,_rgba(255,255,255,0.08),_transparent_30%),linear-gradient(135deg,#05060a_0%,#11131a_45%,#2a0d19_100%)] text-white px-6 py-10">
        ...
        <section className="grid lg:grid-cols-2 gap-6 items-start">
          ...
          <div className="rounded-3xl border border-white/10 bg-white/5 backdrop-blur-xl p-6 shadow-[0_10px_40px_rgba(0,0,0,0.35)]">
            ...
            {loadingImage ? (
              ...
              <div className="min-h-[520px] rounded-3xl border border-dashed border-white/15 flex items-center justify-center text-white/45 text-center p-6 bg-black/15">
          ...
          <div className="rounded-3xl border border-white/10 bg-black/20 p-4 space-y-4">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
              ...
              <button
                ...
                className="rounded-2xl bg-gradient-to-r from-violet-500 to-fuchsia-500 px-5 py-3 font-semibold hover:opacity-90 transition disabled:opacity-50"
              >
